        ...
        <div id="hero" class="p-1">
            <div class="hero-slider overflow-hidden">
                ...
                <div class="slide-item position-relative">
                    <div>
                        <img src="{{ asset('front_assets/img/hero-bg.jpg') }}" class="img-fluid" style="height:65vh;" alt="slide-1">
                    </div>

                    <div class="col-md-6 position-absolute top-50 start-50 translate-middle">
                        <h1>Welcome to <span>{{ $store->where('data_name', 'logo')->value('title') }}</span></h1>
                ...
                <div class="slide-item position-relative">
                    <div>
                        <img src="{{ asset('front_assets/img/testimonials-bg.jpg') }}" class="img-fluid" style="height:65vh;" alt="slide-1">
                    </div>
