...
@section('content')
    <div>
        ...
        <h1 class="text-center text-primary fw-bold">Create Slide</h1>
            ...
            <div class="row g-2 ">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="input-img" name="picture"
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="video-link" name="link" placeholder="title">
                    </div>
                </div>
