            ...
            @csrf
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="preview-img border rounded border-1">
                        <img src="{{ asset('storage/category/'.$category->cat_picture) }}" width="450" class="img-fluid rounded">
                    </div>
                    @error('picture')
            ...
            <div class="row g-2 mt-2">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('title') is-invalid @enderror" id="title" value="{{ old('title',$category->cat_title) }}" name="title"
                            placeholder="Title">
                        @error('title')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
